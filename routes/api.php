...
// Route::post('/khach-hang/don-hang/muatructiep', [ChiTietDonHangController::class, 'muahangtructiep'])->middleware("KhachHangMiddle");
...
Route::post('/khach-hang/don-hang/mua-truc-tiep', [DonHangController::class, 'muaTrucTiep'])->middleware("KhachHangMiddle");
